...
import cn.cqjtyy.commons.utils.{DateUtils, NumberUtils, ParamUtils}
...
object PageOneStepConvertRate {
  ...
  /**
    ...
    * @return
    */
  def generateAndMatchPageSplit(sc: SparkContext,
                                sessionid2actionsRDD: RDD[(String, Iterable[UserVisitAction])],
